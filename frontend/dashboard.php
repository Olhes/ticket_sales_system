    ...
    <div class="container">
        ...
        <main>
            ...
            <div class="dark-mode-toggle">
                <span class="material-icons-sharp active" id="light-mode-toggle">light_mode</span>
                <span class="material-icons-sharp" id="dark-mode-toggle">dark_mode</span>
            </div>
            <div class="insights">
                <div class="sales">
        ...
        async function logout() {
            try {
                ...
                if (result && result.success) {
                    ...
                    alert('Error al cerrar sesión: ' + (result.message || 'Desconocido'));
                }
            } catch (error) {
